...
public class SJSwiftSideMenuController: UIViewController, UINavigationControllerDelegate {
    ...
    public static func setUpNavigation(rootController:UIViewController, leftMenuController : UIViewController?,  leftMenuType: SJSideMenuType, rightMenuType: SJSideMenuType){
    ...
    public static func showLeftMenuNavigationBarButton(image : UIImage , sh_Bool :Bool ){
        shouldShowLeftButton = sh_Bool
        menuIcon_Left = image
    }
